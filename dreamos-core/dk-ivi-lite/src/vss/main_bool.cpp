...
bool getBool_VssApiValue(std::string apiName, std::string &currentTimeStamp)
{
#ifdef USING_VSS
    if (pModule != nullptr) {
...
int main() {
    initPyEnv();
    std::string vapi = "Vehicle.Security.isAttacked";
    std::string timestamp = "";
    bool value = getBool_VssApiValue(vapi, timestamp);
